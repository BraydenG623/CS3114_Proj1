...
public class LeafNodeJunitTests {
    ...
    /*
     * Test remove by name for leaf node
     */
    @Test
    public void testLeafNodeRemoveName() {
        quadTree.insert("r1", 10, 10);
        quadTree.insert("r2", 15, 15);
        quadTree.insert("r3", 7, 7);
        quadTree.insert("r4", 20, 25);
     ...
     */
    @Test
    public void testLeafNodeRemoveValue() {
        quadTree.insert("r1", 10, 10);
        quadTree.insert("r2", 15, 15);
        quadTree.insert("r3", 7, 7);
        quadTree.insert("r4", 20, 25);
    ...
    /*
     * Test region search for leaf node
     */
    @Test
    public void testLeafNodeRegionSearch() {
        quadTree.insert("r1", 10, 10);
        quadTree.insert("r2", 15, 15);
        quadTree.insert("r3", 7, 7);
        quadTree.insert("r4", 20, 25);
    ...
    /*
     * Test duplicates for leaf node
     */
    @Test
    public void testLeafNodeDuplicates() {
        quadTree.insert("r1", 10, 10);
        quadTree.insert("r2", 15, 15);
        quadTree.insert("r3", 7, 7);
        quadTree.insert("r4", 20, 25);
    ...
    /*
     * Test search for leaf node
     */
    @Test
    public void testLeafNodeSearch() {
        quadTree.insert("r1", 10, 10);
        quadTree.insert("r2", 15, 15);
        quadTree.insert("r3", 7, 7);
        quadTree.insert("r4", 20, 25);
    ...
    /*
     * Test dump for leaf node
     */
    @Test
    public void testLeafNodeDump() {
        quadTree.insert("r1", 10, 10);
        quadTree.insert("r2", 15, 15);
        quadTree.insert("r3", 7, 7);
        quadTree.insert("r4", 20, 25);
